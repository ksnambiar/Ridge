...
export class Requests extends Component {
  render() {
      ...
      view = Object.keys(profile.guide_request).map((obj,i)=>{
          ...
          <Button className="like ml2" title="Yes, I will mentor you guys"><Octicon icon={getIconByName("thumbsup")}/></Button>
          <Button className="dislike ml2" title="Sorry, I wont be able to"><Octicon icon={getIconByName("thumbsdown")}/></Button>
          </Card.Body>
          </Card>:null
      })
      if(view.length===0){
